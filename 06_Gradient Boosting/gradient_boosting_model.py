...
class GradientBoostingModel:
    ...
    def load_unified_data(self):
        ...
        # Load unified data
        X_train, X_test, y_train, y_test, feature_names, encoders, preprocessors = prepare_unified_data('CSV')
        
        # Store encoders and preprocessors (train-fitted)
        self.categorical_encoders = encoders
        self.preprocessors = preprocessors
        self.numerical_scaler = preprocessors.get('numerical_scaler') if isinstance(preprocessors, dict) else preprocessors

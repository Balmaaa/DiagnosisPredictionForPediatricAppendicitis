...
class SymptomsFrame:
    ...
    def clear(self):
        self.app.migratory_pain_var.set("")
        self.app.lower_right_abd_pain_var.set("")
        self.app.contralateral_rebound_tenderness_var.set("")
        self.app.coughing_pain_var.set("")
        self.app.nausea_var.set("")
        self.app.loss_of_appetite_var.set("")
        self.app.dysuria_var.set("")
        self.app.stool_var.set("")
        self.app.peritonitis_var.set("")
        self.app.psoas_sign_var.set("")
        self.app.ipsilateral_rebound_tenderness_var.set("")